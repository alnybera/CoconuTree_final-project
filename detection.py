...
def classNames():
    cocoClassNames = ["pohon","person", "bicycle", "car", "motorbike", "aeroplane", "bus", "train", "truck", "boat",
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    # c2 = center_x + textSize[0], center_y - textSize[1] - 3
                    # cv2.putText(im0, label, (center_x, center_y - 2), 0, 0.5, [255, 255, 255], thickness=1,
...
objectDetection("Resources/image1.jpeg")